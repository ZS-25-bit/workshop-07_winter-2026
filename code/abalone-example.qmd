...
abalone_clean <- abalone |> 
  # cleaned names with underscores no cap
  clean_names()  |> 
  # selected for column of interest 
...
ggplot(data = abalone_clean, # data is abalone_clean
       aes(x = mean_ph, # x is the mean_pH (predictor variable)
...
**With each increase in pH, the model predicts an increase of 3.0 +/- in change in shell surface area per day(mm^2^d^-1^)**  
